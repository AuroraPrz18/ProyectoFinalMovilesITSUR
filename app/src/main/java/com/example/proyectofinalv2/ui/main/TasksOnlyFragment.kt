...
class TasksOnlyFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val Note1 = Note(title = "Nota1tasks", description = "Desc1", isTask = true, dateCreation = Date(12, 12, 2022), dateSetter = Date(12, 12, 2022), author = "Yo", media="nada")
        val Note2 = Note(title = "Nota2tasks", description = "Desc2", isTask = true, dateCreation = Date(11, 11, 2021), dateSetter = Date(11, 11, 2021), author = "Yo", media="nada")
